...
// QP Posts routes ===============================================================
    ...
    app.get('/bookmark', isLoggedIn, function(req, res) { 
            db.collection('posts').find({}).toArray((err,result)=>{
              ...
              console.log("bitchhhhhhhh!!!!!")
              console.log(filteredPost)
              // result.forEach((p,i)=>{ 
              //   console.log("LOOK HERE BIOTCHES!!!!!!_____~!!!!")
              //   console.log(p['_id'].toString())
              //   console.log(req.user)
              //   if (req.user.bookmarks.includes(p['_id'].toString())){
    ...
    app.put('/bookmark', isLoggedIn, function(req, res) {
      // req.user.local.bookmarks.push(req.body.postId)
